...
> ⚠️ **隱私提醒：** 備份包含私密內容，建議務必設定密碼保護。

* **Vercel** (推薦：操作最直覺)
    * 方法：直接將資料夾拖放至網頁即可完成部署。
    * [密碼保護功能說明](https://vercel.com/docs/deployment-protection/methods-to-protect-deployments/password-protection) (需確認方案付費支援)
* **Cloudflare Pages**
